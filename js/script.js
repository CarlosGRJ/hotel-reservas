...
$(".mostrarBloqueReservas").click(function(){
    ...
    if($(".mostrarBloqueReservas").attr("modo") == "abajo") {
        ...
        $(".fechaReserva").removeClass("fa-caret-up");

        $(".fechaReserva").addClass("fa-caret-down");

    } else {

        $(".mostrarBloqueReservas").attr("modo", "abajo");

        $(".fechaReserva").removeClass("fa-caret-down");

        $(".fechaReserva").addClass("fa-caret-up");
...
if(window.matchMedia("(max-width:768px)").matches) {
    ...
    $(".restaurante .verCarta").click(function(){
        ...
        $(".restaurante .carta div").css({"background":"rgba(0, 0, 0, .7)"});
...
if(window.matchMedia("(max-width:768px)").matches) {
    ...
    $(".infoPerfil .colIzqPerfil").css({"margin-top":($("header").height()+100)});
